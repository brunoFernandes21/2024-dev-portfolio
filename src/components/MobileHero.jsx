...
const MobileHero = () => {
  return (
    <section className="hero__section mt-10">
      ...
      <button className="flex items-center gap-2 text-md md:text-lg lg:text-xl p-3 px-6 md:p-3 md:px-6 text-slate-100 bg-gradient-to-b from-[#5037d0] to-black rounded-full ">
        <strong>
